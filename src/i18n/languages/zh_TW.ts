...
export const zh_TW: Translation = {
	...
	[Key.dynamicLike]: "點讚",
	[Key.dynamicExtWebsite]: "網頁",
	[Key.dynamicExtGithub]: "GitHub",
	[Key.dynamicExtVideo]: "影片",
	[Key.dynamicExtMusic]: "音樂",
	[Key.dynamicExtTweet]: "推文",
	[Key.dynamicExtJump]: "跳轉",
	...
	[Key.fcircle]: "朋友圈",
	[Key.fcircleDescription]: "看看朋友們最近都在寫些什麼",
	[Key.fcircleLoading]: "正在載入朋友圈動態...",
	[Key.fcircleEmpty]: "暫無朋友圈動態",
	[Key.fcircleError]: "朋友圈資料載入失敗",
	[Key.fcircleErrorDesc]: "無法取得朋友圈資料，請稍後重試",
	[Key.fcircleOpenExternal]: "開啟朋友圈首頁",
	[Key.fcircleRetry]: "重試",
	[Key.fcircleUnreachable]: "無法造訪",
	[Key.fcircleStatsSubscribed]: "訂閱",
	[Key.fcircleStatsActive]: "活躍",
	[Key.fcircleStatsArticles]: "文章",
	[Key.fcircleStatsFailed]: "失敗",
	[Key.fcircleLastUpdated]: "更新時間",
	[Key.fcircleRandomTitle]: "🎲 隨便轉轉",
	[Key.fcircleRandomNext]: "🔄 換一篇",
	[Key.fcircleRandomRead]: "閱讀文章",
	[Key.changelog]: "更新日誌",
	[Key.changelogDescription]: "記錄部落格的功能迭代、問題修復與重要變更",
	[Key.changelogTypeFeature]: "功能新增",
	[Key.changelogTypeImprovement]: "功能優化",
	[Key.changelogTypeFix]: "問題修復",
	[Key.changelogTypeRemoval]: "移除",
	[Key.changelogDetailHint]: "點擊查看詳情",
	[Key.decennialTitle]: "十年之約",
	[Key.decennialSubtitle]: "我的部落格 · 十年之約",
	[Key.decennialDaysCounter]: "已執行天數",
	[Key.decennialCountFrom]: "建站日期",
	[Key.decennialCountTo]: "十年之約到期日",
	[Key.decennialPromiseTitle]: "📄 履約事項：",
	[Key.decennialAchievementTitle]: "🎉 履約成就：",
	[Key.decennialProgressTitle]: "履約進度：",
	[Key.decennialQuote]:
		"十年之約，是堅持，是承諾，是對未來的期許。無論風雨，無論晴好，我會在這裡記錄、分享、成長。",
	[Key.decennialDaysAgo]: "天前發布",
	[Key.decennialDaysToGo]: "天後",
	[Key.decennialCharacterUnit]: "字",
	[Key.decennialDayUnit]: "天",
	[Key.decennialPostUnit]: "篇",
	[Key.decennialAchievementEntry1]: "發布100篇原創文章",
	[Key.decennialAchievementEntry2]: "總字數達10萬字",
	[Key.decennialAchievementEntry3]: "總字數達100萬字",
	[Key.decennialAchievementEntry4]: "正常執行100天",
	[Key.decennialAchievementEntry5]: "正常執行1000天",
	[Key.decennialAchievementEntry6]: "完成十年之約",
	[Key.decennialPromiseEntry1]: "六個月內有新文章發布",
	[Key.decennialPromiseEntry2]: "至少有十篇原創文章",
	[Key.booknav]: "書籤導航",
