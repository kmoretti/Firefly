...
export const ru: Translation = {
	...
	[Key.dynamicExtWebsite]: "Сайт",
	[Key.dynamicExtGithub]: "GitHub",
	[Key.dynamicExtVideo]: "Видео",
	[Key.dynamicExtMusic]: "Музыка",
	[Key.dynamicExtTweet]: "Твит",
	[Key.dynamicExtJump]: "Открыть",
	...
	[Key.fcircle]: "Круг друзей",
	[Key.fcircleDescription]: "Посмотрите, что недавно писали ваши друзья",
	[Key.fcircleLoading]: "Загрузка записей круга друзей...",
	[Key.fcircleEmpty]: "Пока нет записей круга друзей",
	[Key.fcircleError]: "Не удалось загрузить данные круга друзей",
	[Key.fcircleErrorDesc]:
		"Не удалось получить данные круга друзей, попробуйте позже",
	[Key.fcircleOpenExternal]: "Открыть сайт круга друзей",
	[Key.fcircleRetry]: "Повторить",
	[Key.fcircleUnreachable]: "Недоступен",
	[Key.fcircleStatsSubscribed]: "Подписки",
	[Key.fcircleStatsActive]: "Активные",
	[Key.fcircleStatsArticles]: "Статьи",
	[Key.fcircleStatsFailed]: "Ошибки",
	[Key.fcircleLastUpdated]: "Обновлено",
	...
	[Key.decennialTitle]: "Десятилетний договор",
	[Key.decennialSubtitle]: "Мой блог · Десятилетний договор",
	[Key.decennialDaysCounter]: "Дней с запуска",
	[Key.decennialCountFrom]: "Дата запуска",
	[Key.decennialCountTo]: "Окончание договора",
	...
	[Key.decennialDayUnit]: "дн.",
	[Key.decennialPostUnit]: "публикаций",
	[Key.decennialAchievementEntry1]: "Опубликовать 100 оригинальных статей",
	[Key.decennialAchievementEntry2]: "Написать 100 тыс. знаков",
	[Key.decennialAchievementEntry3]: "Написать 1 млн знаков",
	[Key.decennialAchievementEntry4]: "100 дней нормальной работы",
	[Key.decennialAchievementEntry5]: "1000 дней нормальной работы",
	[Key.decennialAchievementEntry6]: "Выполнить десятилетний договор",
	[Key.decennialPromiseEntry1]: "Новая статья не реже раза в полгода",
	[Key.decennialPromiseEntry2]: "Не менее десяти оригинальных статей",
	...
	[Key.goPageTitle]: "Вы покидаете этот сайт",
	[Key.goPageDescription]:
		"Внешние ссылки в статьях проходят через страницу перехода. Проверьте безопасность ссылки перед переходом.",
	[Key.goLeaveText]: "Вы собираетесь покинуть этот сайт и перейти по ссылке:",
	[Key.goAutoJump]: "Переход через",
	[Key.goJumpNow]: "Перейти сейчас",
	[Key.goBackHome]: "Вернуться на главную",
	[Key.goInvalidLink]:
		"Ссылка недействительна или повреждена, переход невозможен",
	[Key.goWarning]:
