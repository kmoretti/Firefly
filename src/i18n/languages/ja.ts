...
export const ja: Translation = {
	...
	[Key.dynamicLike]: "いいね",
	[Key.dynamicExtWebsite]: "ウェブ",
	[Key.dynamicExtGithub]: "GitHub",
	[Key.dynamicExtVideo]: "動画",
	[Key.dynamicExtMusic]: "音楽",
	[Key.dynamicExtTweet]: "ポスト",
	[Key.dynamicExtJump]: "開く",
	...
	[Key.fcircle]: "フレンドサークル",
	[Key.fcircleDescription]: "友達の最近の投稿を見てみましょう",
	[Key.fcircleLoading]: "フレンドサークルを読み込み中...",
	[Key.fcircleEmpty]: "まだフレンドサークルの投稿はありません",
	[Key.fcircleError]: "フレンドサークルのデータを読み込めませんでした",
	[Key.fcircleErrorDesc]:
		"フレンドサークルのデータを取得できませんでした。後でもう一度お試しください",
	[Key.fcircleOpenExternal]: "フレンドサークルのサイトを開く",
	[Key.fcircleRetry]: "再試行",
	[Key.fcircleUnreachable]: "アクセス不可",
	[Key.fcircleStatsSubscribed]: "購読",
	[Key.fcircleStatsActive]: "アクティブ",
	[Key.fcircleStatsArticles]: "記事",
	[Key.fcircleStatsFailed]: "失敗",
	[Key.fcircleLastUpdated]: "更新時刻",
	[Key.fcircleRandomTitle]: "🎲 ランダムに読む",
	[Key.fcircleRandomNext]: "🔄 別の記事へ",
	[Key.fcircleRandomRead]: "記事を読む",
	[Key.changelog]: "更新履歴",
	[Key.changelogDescription]: "ブログの機能追加・修正・重要な変更を記録",
	[Key.changelogTypeFeature]: "新機能",
	[Key.changelogTypeImprovement]: "改善",
	[Key.changelogTypeFix]: "修正",
	[Key.changelogTypeRemoval]: "削除",
	[Key.changelogDetailHint]: "クリックで詳細を表示",
	[Key.decennialTitle]: "十年の契約",
	[Key.decennialSubtitle]: "私のブログ · 十年の契約",
	[Key.decennialDaysCounter]: "運営日数",
	[Key.decennialCountFrom]: "サイト開設日",
	[Key.decennialCountTo]: "十年の契約期日",
	...
	[Key.decennialDayUnit]: "日",
	[Key.decennialPostUnit]: "篇",
	[Key.decennialAchievementEntry1]: "100本のオリジナル記事の投稿",
	[Key.decennialAchievementEntry2]: "累計10万字",
	[Key.decennialAchievementEntry3]: "累計100万字",
	[Key.decennialAchievementEntry4]: "100日間の正常運営",
	[Key.decennialAchievementEntry5]: "1000日間の正常運営",
	[Key.decennialAchievementEntry6]: "十年の契約の達成",
	[Key.decennialPromiseEntry1]: "6ヶ月以内に新しい記事の投稿",
	[Key.decennialPromiseEntry2]: "10本以上のオリジナル記事",
	[Key.booknav]: "ブックマーク集",
	...
	[Key.siteStatsSiteLaunch]: "サイト開設から",
