...
export const zh_CN: Translation = {
	...
	[Key.dynamicLike]: "点赞",
	[Key.dynamicExtWebsite]: "网页",
	[Key.dynamicExtGithub]: "GitHub",
	[Key.dynamicExtVideo]: "视频",
	[Key.dynamicExtMusic]: "音乐",
	[Key.dynamicExtTweet]: "推文",
	[Key.dynamicExtJump]: "跳转",
	...
	[Key.fcircle]: "朋友圈",
	[Key.fcircleDescription]: "看看朋友们最近都在写些什么",
	[Key.fcircleLoading]: "正在加载朋友圈动态...",
	[Key.fcircleEmpty]: "暂无朋友圈动态",
	[Key.fcircleError]: "朋友圈数据加载失败",
	[Key.fcircleErrorDesc]: "无法获取朋友圈数据，请稍后重试",
	[Key.fcircleOpenExternal]: "打开朋友圈首页",
	[Key.fcircleRetry]: "重试",
	[Key.fcircleUnreachable]: "不可访问",
	[Key.fcircleStatsSubscribed]: "订阅",
	[Key.fcircleStatsActive]: "活跃",
	[Key.fcircleStatsArticles]: "文章",
	[Key.fcircleStatsFailed]: "失败",
	[Key.fcircleLastUpdated]: "更新时间",
	[Key.fcircleRandomTitle]: "🎲 随便转转",
	[Key.fcircleRandomNext]: "🔄 换一篇",
	[Key.fcircleRandomRead]: "阅读文章",
	[Key.changelog]: "更新日志",
	[Key.changelogDescription]: "记录博客项目的功能迭代、问题修复与重要变更",
	[Key.changelogTypeFeature]: "功能新增",
	[Key.changelogTypeImprovement]: "功能优化",
	[Key.changelogTypeFix]: "问题修复",
	[Key.changelogTypeRemoval]: "移除",
	[Key.changelogDetailHint]: "点击查看详情",
