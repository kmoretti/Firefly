...
import FriendlinkSubmission from "@components/pages/FriendlinkSubmission.svelte";
...
<div class="not-prose my-4">
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-2.5 flex-1">
          {[
            ...
            { label: "站点截图", value: site.image },
            { label: "RSS 地址", value: site.rss },
          ].map((item) => (
      ...
      <div class="p-5 sm:p-6 flex flex-col flex-1">
        ...
        <div class="space-y-0 flex-1">
          ...
          <div class="flex gap-3.5">
            ...
            <div class="pb-4">
              <p class="font-semibold text-sm mb-1">通过下方申请表单提交</p>
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">在下方表单中填写站点名称、地址、描述、头像、友链页面、站点截图与 RSS 地址并提交，无需邮件或评论区留言</p>
            </div>
          </div>
          ...
          <div class="flex gap-3.5">
            ...
            <div>
              ...
              <p class="text-xs text-neutral-500 dark:text-neutral-400 leading-relaxed">提交后可在下方申请状态列表实时查询进度，确认信息无误后会尽快添加您的友链</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <FriendlinkSubmission client:load />
</div>
